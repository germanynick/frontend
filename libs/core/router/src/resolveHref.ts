//TODO: @Copy-right from expo-router. Replace it
import { Href, HrefObject } from './interfaces';
...
function createQualifiedPathname(pathname: string, params: Record<string, any>): Omit<Required<HrefObject>, 'query'> {
